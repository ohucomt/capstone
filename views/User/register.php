    ...
    <div class="card-block">
        ...
        <!--Body-->
            ...
            <div class="md-form">
                <input onchange="checkUniqueMail(this.value)" type="email" name="email" id="form2" class="form-control validate" required >
                <label for="form2">Your email</label>
                <p style="color: red;" id="email"></p>
            </div>
            
            <div class="md-form">
                <input type="text" name="username" id="form2" class="form-control validate" required onchange="checkUniqueUser(this.value)">
